...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
	private BlurMaskFilter blurMaskFilter1 = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
	private BlurMaskFilter blurMaskFilter2  = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
	private BlurMaskFilter blurMaskFilter3  = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
	private BlurMaskFilter blurMaskFilter4  = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
